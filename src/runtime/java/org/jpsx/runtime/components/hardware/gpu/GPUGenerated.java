...
/**
 * Placeholder class enclosing rendering classes that are dynamically generated as needed at runtime.
 *
 * Each class represents a (quad/triangle/line/sprite) representer with one set of rendering options (e.g.
 * palette size, semi-transparency, gouraud-ness, masking etc.)
 * 
 * To save space the compiled class files are actually deleted by the build
 */
public class GPUGenerated {

    public static class _Q400000 {
        public static void render(GPU.PolygonRenderInfo info, GPU.Vertex v0, GPU.Vertex v1, GPU.Vertex v2, GPU.Vertex v3) {
        }
    }
    ...
    public static class _T010001 {
        public static void render(GPU.PolygonRenderInfo info, GPU.Vertex v0, GPU.Vertex v1, GPU.Vertex v2) {
        }
    }
    ...
    public static class _S000000 {
        public static void render(GPU.PolygonRenderInfo info, int x, int y, int w, int h) {
        }
    }
    ...
    public static class _L010000 {
        public static void render(GPU.LineRenderInfo info, GPU.Vertex v0, GPU.Vertex v1) {
        }
    }
